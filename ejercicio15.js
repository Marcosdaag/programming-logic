...
Creamos una funcion commoChar la cual recibe un parametro de texto, despues inicializamos 3 variables, una es un JSON vacio para ir almacenando los caracteres y sus valores, max para almacenar el valor actual de repeticiones del caracter mas usado y por ultimo maxRepeatCharacter para almacenar en forma de string la letra como tal que mas se repite.
Hacemos un bucle for con un OF para sacar el valor de cada caracter del texto, si el caracter no existe en el JSON lo inicializo y en caso de que ya exista le sumo 1 a su contador.
