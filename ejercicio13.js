...
Creo una variable last para restarle un slot a arrayIn para que realmente meta la cantidad de elementos que le pasemos a la funcion ya que los arrays se inicializan en cero y al restarle uno va a respetar el parametro que le asignemos. Despues de eso creamos una condicion en la que si no hay mas espacio en el array anterior  y si size es el que asignamos, creamos  un nuevo array y pusheamos el elemento que se esta iterando y en caso de que el array siga teniendo slots disponibles con un ELSE hacemos un push al array actual.
